                        ...
                        <div class="login-content">
                          <div class="login-header">
                            <?php
                              ...
                              $re_pwd=$_POST["re_pwd"];
                              $qry="select * from candidate_master where serial_key='".$k."' and password='".$old_pwd."'";
                              ...
                              if($rows == 1)
                              {
                                if($new_pwd==$re_pwd)
                                {
                                  $cnd=mysqli_fetch_array($result);
                                  $data['password']=$new_pwd;
                                  $con->updatation("candidate_master",$data,"cnd_id",$cnd['cnd_id']);
