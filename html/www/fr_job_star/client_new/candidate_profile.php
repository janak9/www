              ...
              <div class="personal-data col-md-9 col-sm-9">
                ...
                <div class="col-md-12 no-l-padding sec-q-pad-t content">
                  ...
                  <?php
                    $cnd=$con->select_up("candidate_master","serial_key",$k);
                    $cnd_id= $cnd["cnd_id"];
                    $edu=$con->select_mul("education_master","cnd_id",$cnd_id);
                  ...
                  <div class="education-timeline sec-q-pad-t sec-q-pad-b">
                    <div class="container timeline-container">
                      ...
                      <div class="col-md-9 col-sm-9">
                        <ul class="timeline">
                          <?php
                            while($education=mysqli_fetch_array($edu))
                              {
                            ?>
                          <li>
                   ...
                   $cnd=$con->select_up("candidate_master","serial_key",$k);
                    ...
                    $exp=$con->select_mul("experience_master","cnd_id",$cnd_id);
                    ...
                    <div class="work-exp-timeline sec-q-pad-t sec-q-pad-b">
                      <div class="container timeline-container">
                        ...
                        <div class="col-md-9 col-sm-9">
                          <ul class="timeline">
                            <?php
                            while($experience=mysqli_fetch_array($exp))
                              {
                            ?>
                            <li>
                              <div class="timeline-icon">
                              ...
                              <div class="timeline-label">
                                ...
                                <p><i class="fa fa-map-marker"></i><?php echo "$state[1] , $city[2]"; ?></p>
                              </div>
                              </div>
                            </li>
                            <?php } ?>
