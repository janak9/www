...
<!-- Mirrored from demo.suavedigital.com/jobstar/error-404.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 05 Mar 2018 11:30:56 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <link href="assets/stylesheets/css/style.html" rel="stylesheet">
  </head>
  ...
  <!-- Error 404 Begin -->
    <section class="error-404">
      <div class="container fullheight">
        <div class="smoke-bg" style="background: url(assets/images/404-bg.png) no-repeat"></div>

        <div class="valign-wrap fullheight fullwidth">
          <div class="left-section">
            <div class="text-wrapper">
              <h2 class="error-message-subtitle">Error</h2>
          ...
          <div class="right-section">
            <div class="text-center">
              <a href="index.php" class="def-btn btn-bg-yellow">BACK TO HOME</a>
            </div>
            <br>
            <div class="rocket fullheight halfwidth animated wow fadeInUp" style="background: url('assets/images/rocket.png') no-repeat; background-size: 100%;">
            </div>
          </div><!--/.right-section -->
...
<!-- Mirrored from demo.suavedigital.com/jobstar/error-404.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 05 Mar 2018 11:31:04 GMT -->
</html>